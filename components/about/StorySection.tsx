  ...
  return (
    ...
    >
      ...
      <motion.h2
        ...
        animate={isInView ? { opacity: 1, y: 0 } : {}}
        transition={{ duration: 0.4, delay: index * 0.1 + 0.4, ease: [0.16, 1, 0.3, 1] }}
        viewport={{ once: true }}
      ...
      <motion.p
        initial={{ opacity: 0, y: 20 }}
        animate={isInView ? { opacity: 1, y: 0 } : {}}
        transition={{ duration: 0.4, delay: index * 0.1 + 0.5, ease: [0.16, 1, 0.3, 1] }}
        viewport={{ once: true }}
...
export default function StorySection() {
  ...
  // Parallax for background elements - use duration-based instead of spring
