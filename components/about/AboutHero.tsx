...
// Floating geometric elements with purple glow - desktop only
...
// CSS-based gradient for mobile - no JS animation
...
export default function AboutHero() {
  ...
  // Replace spring with duration-based easing for mobile performance
  const smoothY = useTransform(scrollYProgress, [0, 1], [0, 150]);
  ...
  return (
    ...
    >
      {/* Desktop: Spline 3D Background - only render when NOT mobile */}
      ...
      {/* Mobile gradient background - static CSS, no animation */}
      ...
      <motion.div
        ...
        style={{ y: smoothY, willChange: "transform", transform: "translateZ(0)" }}
      >
        <span
